...
public unsafe partial struct StatusManager {
    ...
    [FieldOffset(0x170)] public uint Flags1;
    [FieldOffset(0x174)] public ushort Flags2;
    [FieldOffset(0x178)] public long Unk_178;
    //[FieldOffset(0x2E8)] public byte Unk_180;
    [FieldOffset(0x180)] public byte NumValidStatuses;
    ...
    [MemberFunction("83 FA ?? 72 ?? 0F 57 C0 C3 8B C2 48 FF C0")]
    ...
    [MemberFunction("E8 ?? ?? ?? ?? 83 FF 1E")] // TODO 6.40
