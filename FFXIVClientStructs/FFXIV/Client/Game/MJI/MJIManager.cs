...
public unsafe partial struct MJIManager {
    ...
    [FieldOffset(0x184)] public fixed byte LandmarkPlacements[5 * MJILandmarkPlacement.Size]; // ??
    ...
    [FieldOffset(0x1B4)] public fixed byte BuildingPlacements[6 * MJIBuildingPlacement.Size];
    ...
    [FieldOffset(0x272)] public fixed byte SupplyAndDemandShifts[71];
