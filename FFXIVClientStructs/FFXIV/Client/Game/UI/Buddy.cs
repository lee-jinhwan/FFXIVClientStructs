...
public unsafe partial struct Buddy {
    ...
    [FieldOffset(0xE64)] private fixed byte BuddyEquipUnlockBitmask[96 >> 3]; // number of BuddyEquip rows >> 3
    [FieldOffset(0xE70)] private byte BardingHead;
    [FieldOffset(0xE71)] private byte BardingChest;
    [FieldOffset(0xE72)] private byte BardingFeet;
