...
public unsafe partial struct GroupManager {
    ...
    [FieldOffset(0x1180)] public fixed byte PartyMembers[0x230 * 8]; // PartyMember type
    [FixedSizeArray<PartyMember>(20)]
    [FieldOffset(0x1C80)] public fixed byte AllianceMembers[0x230 * 20]; // PartyMember type
