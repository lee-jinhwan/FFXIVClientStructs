...
public unsafe partial struct RaptureAtkModule {
    ...
    [FieldOffset(0x8787)] public AgentUpdateFlags AgentUpdateFlag; // reset happens in RaptureAtkModule_OnUpdate
    [FieldOffset(0x10820)] public Utf8String* AddonNames; // pointer to an array of 837 Utf8Strings

    [FieldOffset(0x108F0)] public AgentModule AgentModule;

    [FieldOffset(0x11690)] public RaptureAtkUnitManager RaptureAtkUnitManager;

    [FieldOffset(0x1B310), Obsolete("Use RaptureAtkUnitManager.Flags", true)] public RaptureAtkModuleFlags Flags; // TODO: this is actually at RaptureAtkUnitManager + 0x9C80
    ...
    [FieldOffset(0x289A0)] public AtkTexture CharaViewDefaultBackgroundTexture; // "ui/common/CharacterBg.tex" (or _hr1 variant)
